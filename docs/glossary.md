...
The same Change Rule is a pragmatic hack on the patch algebra, which allows
us to consider a conflict as automatically resolved when two sides are same.
...
consequences like when you reabase a commit to ustream and the upstream rebased
