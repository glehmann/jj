...
fn test_squash_option_exclusion() {
    ...
    ------- stderr -------
    error: the argument '--destination <REVSETS>' cannot be used with '--use-destination-message'
...
fn test_squash_to_new_commit() {
    ...
    ├─╮  file 3&4
    │ │  -- operation 7964d08317bf (2001-02-03 08:05:31) squash commit 0d254956d33ed5bb11d93eb795c5e514aadc81b5 and 1 more
